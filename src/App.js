function App() {
  return (
    <div className="container  dpy-f fdxn-c bg-error text-white br-sm">
     ...
     <p className="p-md mw-lg bg-orange m-2">
     ...
     <a href="https://google.com" className="text-white bg-green mw-sm dpy-f  p-md br-sm text-hover-purple">I am a Button</a>
     <h2 className="fs-xl p-sm">No CRA * REACT</h2>
    </div>
  );
}
